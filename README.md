...
The CAD for the modules is generated by script, headless (FreeCAD + reportlab), not by
hand in a GUI. See:

- [AGENTS.md](AGENTS.md) — how to work here, house rules and module status
- [docs/cad-workflow.md](docs/cad-workflow.md) — the drawing pipeline and its pitfalls
